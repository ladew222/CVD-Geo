...
$(document).ready(function(){
    ...
    $( "#slider-range" ).slider({
        range: true,
        min: new Date('2020-02-15').getTime() / 1000,
    ...
    if (viz.plot_details==false){
        viz.nested_data = d3.nest()
            ...
            .rollup(function(v) { return {
                ...
                log_total_death: d3.sum(v, function(d) { return isFinite(Math.log10(d.Death))?Math.log10(d.Death):0 }),
                log_total_confirmed: d3.sum(v, function(d) { return isFinite(Math.log10(d.Confirmed)) ? Math.log10(d.Confirmed): 0 }),
